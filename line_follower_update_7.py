...
class TurtleBotBrain(Node):
    def __init__(self):
        ...
        self.obstacle_approach_offset = 0.10 # 10cm gap to leave between robot and obstacle
        ...
        self.topple_wait_duration = 6.0      # Max seconds to wait for topple confirmation
